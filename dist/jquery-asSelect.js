...
(function(global, factory) {
  ...
  var asSelect = (function() {
    function asSelect(element) {
      ...
      // options
      var metas = [];
      _jquery2.default.each(this.$select.data(), function(k, v) {
      ...
      [
        {
          ...
          value: function init() {
            ...
            this.$label = (0, _jquery2.default)(
              '<div class="' +
                this.classes.label +
                '">' +
                this.options.render.label() +
                '</div>'
            ).prependTo(this.$trigger);
            this.$dropdown = (0, _jquery2.default)(
              '<div class="' + this.classes.dropdown + '"><ul></ul></div>'
            );
          ...
          value: function render(data) {
            ...
            var buildOption = function buildOption(item) {
              return (
                ...
                that.classes.item +
                '">' +
                that.options.render.option.call(that, item) +
                '</li>'
              );
            };
            ...
            _jquery2.default.each(data, function(i, item) {
              if (item.group) {
                ...
                html +=
                  ...
                  that.namespace +
                  '-group-label">' +
                  that.options.render.group.call(that, item) +
                  '</div>';
                html += '<ul>';

                if (_jquery2.default.isArray(item.options)) {
                  _jquery2.default.each(item.options, function(j, option) {
          ...
          value: function parse($selects) {
            ...
            $selects.each(function() {
              if (this.tagName.toLowerCase() === 'optgroup') {
                var group = _jquery2.default.extend(
                  {},
                  (0, _jquery2.default)(this).data(),
                  {
                    group: true,
        ...
        },
        {
          ...
          value: function _set(index) {
            ...
            if (this.$options.length) {
              (0, _jquery2.default)(this.$options[index]).prop(
                'selected',
                true
              );
            }
        ...
        },
        {
          ...
          value: function getCurrentData(index) {
            var count = 0;
            var result = null;
            _jquery2.default.each(this.data, function(i, item) {
              if (item.group) {
                if (_jquery2.default.isArray(item.options)) {
                  _jquery2.default.each(item.options, function(j, option) {
                    count++;
        ...
        },
        {
          ...
          value: function replaceDiacritics(s) {
            ...
            try {
              for (
                var _iterator = d[Symbol.iterator](), _step;
        ...
        },
        {
          ...
          value: function keyboardEvent() {
            var that = this;
            (0, _jquery2.default)(document).on('keydown.asSelect', function(e) {
        ...
        },
        {
          ...
          value: function search(key) {
            ...
            _jquery2.default.each(this.$items, function(index, value) {
              /*eslint consistent-return: "off"*/
              var string = _jquery2.default.trim(
                (0, _jquery2.default)(value).text()
              );
        ...
        },
        {
          ...
          value: function closeAll() {
            _jquery2.default.each(instances, function(key, instance) {
              if (instance.opened) {
                instance.close();
              }
            });
